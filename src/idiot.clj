...
(defn hash-object [arg]
  (cond
    ...
    (and (= 2 (count arg)) (= "-w" (nth arg 0))) (if (.isFile (io/file (nth arg 1)))
                                                   (hash-object-helper "-w" (nth arg 1))
                                                   (println "Error: that file isn't readable"))
    (and (= 1 (count arg)) (not (= "-w" (nth arg 0)))) (if (.isFile (io/file (nth arg 0)))
...
(defn cat-file [arg]
  (cond
    ...
    (not (.isDirectory (io/file ".git"))) (println "Error: could not find database. (Did you run `idiot init`?)")
    (and (= 2 (count arg)) (= "-p" (nth arg 0))) (let [blob-location (str ".git/objects/" (subs (nth arg 1) 0 2) "/" (subs (nth arg 1) 2))]
